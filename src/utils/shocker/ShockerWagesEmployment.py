...
class ShockerWagesEmployment:
    ...
    def __init__(self, type_, name_, thresholdWR, thresholdER, negative_shock, positive_shock, shock_only_once, n_outports, n_outports_to_shock, nombre_shock):
        ...
        self.negative_shock = negative_shock
        self.positive_shock = positive_shock
    ...
    def generate_shocker(self, folder):
        ...
        thresholdWR = self.thresholdWR
        thresholdER = self.thresholdER
        negative_shock = self.negative_shock
        positive_shock = self.positive_shock

        context = {
            'thresholdWR': thresholdWR,
            'thresholdER': thresholdER,
            'negative_shock': negative_shock,
            'positive_shock': positive_shock,
