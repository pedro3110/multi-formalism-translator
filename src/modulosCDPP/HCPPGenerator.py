from src.modulosCDPP.HCPPAtomic.HCPPAtomicGenerator import HCPPAtomicGenerator
...
from src.modulosCDPP.HCPPConfiguration.HCPPEvents import HCPPEvents
from src.modulosCDPP.HCPPConfiguration.HCPPRegFile import HCPPRegFile
